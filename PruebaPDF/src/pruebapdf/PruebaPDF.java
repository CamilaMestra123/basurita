...
public class PruebaPDF {
    public static void crearBlog(String titulo, String texto){
        ...
        BaseColor micolor = new BaseColor(0, 215, 255);
        Font MyFont = FontFactory.getFont(BaseFont.TIMES_ROMAN, 25, micolor);
        Font FlowFont = FontFactory.getFont(BaseFont.TIMES_ROMAN, 25, BaseColor.BLUE);
        
        Paragraph title = new Paragraph(titulo, MyFont);
